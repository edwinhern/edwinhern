...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is edwin.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at unt (go mean green!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm studying computer engineering and mathematics.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i love drinking boba and coffee.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also love to code!")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
